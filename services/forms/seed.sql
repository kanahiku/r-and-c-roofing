...
-- from_email uses Resend's test sender until randcroofing.com is verified.
-- After DNS is verified, update from_email to: noreply@randcroofing.com
...
VALUES (
  ...
  'R&C Roofing Contractors',
  '["http://localhost:4321","https://*.vercel.app","https://randcroofing.com","https://www.randcroofing.com"]'
);
